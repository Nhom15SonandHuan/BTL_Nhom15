...
namespace GymRoom.Controllers
{
    public class TinhTrangController : Controller
    {
        ...
        public TinhTrangController(GymRoomContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("MaTinhTrang,TenND,TinhTrangND")] TinhTrang tinhTrang)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("MaTinhTrang,TenND,TinhTrangND")] TinhTrang tinhTrang)
        {
        ...
        {
            return _context.TinhTrang.Any(e => e.MaTinhTrang == id);
        }
    }
}
